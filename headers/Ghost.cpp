...
// -----------------------------------------------------------------------------
// Limit the movement of ghosts to only between pellets
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// find next distenation of the ghosts
// -----------------------------------------------------------------------------
void Ghost::findDst(const std::vector<std::pair<int, int>>& pellets, int index)
{
    std::vector<std::pair<int, int>> candidtates(4, srcPellets[index]); //srcpallet 5,7
